  ...
  return (
    ...
    <>
     <Toaster/>
        ...
        <div className=' w-full  h-auto bg-gray-100 pt-12  max-sm:pt-[300px]  '>
                      ...
                      <div className=' max-sm:w-full sm:w-[85%] h-[500px]  pt-4   overflow-scroll overflow-y-hidden  flex justify-center  gap-2 items-center  flex-col flex-wrap  '>
                             {
                                Hotel_data.hotelDetails.map((item,i)=>
                                         ...
                                         <div className=' max-[639px]:w-10/12  max-sm:px-2 sm:w-[280px] h-[95%]  flex  items-center flex-wrap  rounded-t-lg shadow-lg '>
